...
fetch('/pt/AddToCart_addProduct/~add_product_id=2916883/~quantity=1/~_2916883_quantity=1/~redirectView=product2916883/~product_id=undefined', {
  method: 'POST',
...
fetch('/pt/ajax/rest/model/atg/commerce/order/purchase/CartModifierActor/addItemToOrder', {
  method: 'POST',
  credentials: 'same-origin',
  body: formData,
});
